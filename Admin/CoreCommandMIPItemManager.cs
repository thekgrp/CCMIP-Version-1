...
namespace CoreCommandMIP.Admin
{
    ...
    public class CoreCommandMIPItemManager : ItemManager
    {
        ...
        public CoreCommandMIPItemManager(Guid kind) : base()
        {
            _kind = kind;
        }
        ...
        {
            return new CoreCommandMIPAddUserControl();
        }
        ...
        {
            CurrentItem = new Item(suggestedFQID, ((CoreCommandMIPAddUserControl)addUserControl).ItemName);
            Configuration.Instance.SaveItemConfiguration(CoreCommandMIPDefinition.CoreCommandMIPPluginId, CurrentItem);
            return CurrentItem;
        }
        ...
        public override void DeleteItem(Item item)
        {
            if (item != null)
            {
                Configuration.Instance.DeleteItemConfiguration(CoreCommandMIPDefinition.CoreCommandMIPPluginId, item);
            }
        ...
        public override List<Item> GetItems()
        {
            ...
            List<Item> items = Configuration.Instance.GetItemConfigurations(CoreCommandMIPDefinition.CoreCommandMIPPluginId, null, _kind);
            return items;
        }
        ...
        {
            List<Item> items = Configuration.Instance.GetItemConfigurations(CoreCommandMIPDefinition.CoreCommandMIPPluginId, parentItem, _kind);
            return items;
        }
        ...
        {
            Item item = Configuration.Instance.GetItemConfiguration(CoreCommandMIPDefinition.CoreCommandMIPPluginId, _kind, fqid.ObjectId);
            return item;
        }
