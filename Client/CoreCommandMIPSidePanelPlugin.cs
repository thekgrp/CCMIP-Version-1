...
namespace CoreCommandMIP.Client
{
    ...
    /// </summary>
    public class CoreCommandMIPSidePanelPlugin : SidePanelPlugin
    {
        /// <summary>
        ...
        //{
        //	return new CoreCommandMIPSidePanelUserControl();
        //}
        ...
        {
            return new CoreCommandMIPSidePanelWpfUserControl();
        }
        ...
        {
            get { return CoreCommandMIPDefinition.CoreCommandMIPSidePanel; }
        }
        ...
        {
            get { return "CoreCommandMIP Side panel"; }
        }
