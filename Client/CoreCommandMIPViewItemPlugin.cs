...
namespace CoreCommandMIP.Client
{
    ...
    /// </summary>
    public class CoreCommandMIPViewItemPlugin : ViewItemPlugin
    {

        public CoreCommandMIPViewItemPlugin()
        {
        }
        ...
        {
            get { return CoreCommandMIPDefinition.CoreCommandMIPViewItemPlugin; }
        }
        ...
        {
            return new CoreCommandMIPViewItemManager();
        }
