...
{
    public class CoreCommandMIPWorkSpacePlugin : WorkSpacePlugin
    {
        ...
        {
            get { return CoreCommandMIPDefinition.CoreCommandMIPWorkSpacePluginId; }
        }
        ...
        public override void Init()
        {
            ...
            ViewAndLayoutItem.InsertViewItemPlugin(1, new CoreCommandMIPWorkSpaceViewItemPlugin(), new Dictionary<string, string>());
