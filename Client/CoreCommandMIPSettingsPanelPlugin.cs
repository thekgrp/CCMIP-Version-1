...
{
    public class CoreCommandMIPSettingsPanelPlugin : SettingsPanelPlugin
    {
        ...
        {
            get { return CoreCommandMIPDefinition.CoreCommandMIPSettingsPanel; }
        }

        /// <summary>
        /// Should return the title of this plug-in. It will be displayed in the Settings panel navigation list.
        /// </summary>
        public override string Title { get { return "CoreCommandMIP"; } }
        ...
        {
            _userControl = new CoreCommandMIPSettingsPanelControl(this);
            return _userControl;
        }
